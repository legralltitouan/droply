    ...
    public static class Localization
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> _strings = new()
        {
            ["fr"] = new()
            {
                ...
                ["L.Settings.Stats"] = "Statistiques",
                ["L.Settings.StatsHint"] = "Voir l'usage Droply de ce PC",
                ["L.Settings.StatsBack"] = "← Retour",
                ["L.Stats.Title"] = "Statistiques",
                ["L.Stats.PcName"] = "Nom du PC",
                ["L.Stats.TotalTransferred"] = "Total transféré",
                ["L.Stats.SentToday"] = "Envoyé aujourd'hui",
            },
            ["en"] = new()
            {
                ...
                ["L.Settings.Stats"] = "Statistics",
                ["L.Settings.StatsHint"] = "View Droply usage on this PC",
                ["L.Settings.StatsBack"] = "← Back",
                ["L.Stats.Title"] = "Statistics",
                ["L.Stats.PcName"] = "PC name",
                ["L.Stats.TotalTransferred"] = "Total transferred",
                ["L.Stats.SentToday"] = "Sent today",
            }
        };
