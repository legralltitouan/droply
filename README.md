...
[![Ask DeepWiki](https://devin.ai/assets/askdeepwiki.png)](https://deepwiki.com/legralltitouan/Droply)
...
*   **Unintrusive & Smart**: Droply respects your workspace. It auto-hides when the taskbar is hidden, ensuring zero visual overlap.
*   **Live Localization**: Switch instantly between English and French directly from the settings, with zero app restarts required.

---

## 🔀 Smart Routing Engine

You never have to worry about file sizes or failed uploads. Droply's dynamic routing guarantees your file is uploaded using the fastest and most stable service available:

| Payload Size      | Infrastructure     | Best Used For                                           |
| :---------------- | :----------------- | :------------------------------------------------------ |
| **0 MB – 2 GB**   | **Gofile.io**      | Lightning-fast transfers for everyday documents and images. |
| **2 GB – 25 GB**  | **Storage.to**     | Heavy media, high-res video projects, and dense archives. |
| **25 GB – 100 GB**| **Pixeldrain.com** | Massive payloads, raw datasets, and full system backups.  |
...
3.  **Right-click** the Droply icon on your taskbar to open **Settings**.
4.  Configure your preferred theme (Light/Dark mode), language, and startup behaviors.

<div align="center">
  <img src="assets/4.png" width="200" alt="Context Menu" />
</div>
...
This project is licensed under the terms of the **MIT License**. Check out the `LICENSE.md` file for detailed clauses.
